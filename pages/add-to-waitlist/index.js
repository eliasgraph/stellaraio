  ...
  return (
    <>
        ...
        <CardGradient height={"43.1rem"}>
          <div className="join-waitlist-div px-3">
            ...
            <p className="text-center">
              Stellar handles the checkout process for you, ensuring you get the{" "}
              <br /> products you want before anyone else.
            </p>
      ...
      <section className="n-m-restock mt-20px">
        <CardGradient>
          <div className="n-m-restock-div px-3">
            <h2 className="app-h2 text-center">
              The Quickest path to the most <br /> in-demand products.
            </h2>
            <h2 className="app-h2 text-center app-color-primary mb-30px">
              Sneakers. Console. Trading cards.
            </h2>
      ...
      <section className="a-t-w">
        <h2 className="app-h2 text-center">
          Stellar AIO works where you shop!
        </h2>
        <p className="text-center">
          Proven Performance, so you never miss a release.
        </p>
        <div className="d-flex justify-content-between align-items-center a-t-w-wrapper">
          <div className="a-t-w-sponsors">
            {isTab ? (
              <img width={"100%"} src={sponsors} alt="sponsors" />
            ) : (
              <img width={"100%"} src={sponsorsls} alt="sponsors" />
            )}
          </div>
          {isMobile ? (
            ...
            <div className="a-t-w-benefits  text-center">
              <div className="test1 mb-20px mt-20px">
                <img
                  style={{ position: "absolute", top: "-16px", left: "39%" }}
                  src={compass}
                  alt=""
                />
                <img src={subtract} alt="" />
                <p className="compass-text mb-0 text-center">
                  5 milliseconds <br /> Checkout <br /> time
                </p>
              </div>
              <div className="test2 mb-20px">
                <img
                  style={{ position: "absolute", top: "-12px", left: "38%" }}
                  src={cart}
                  alt=""
                />
                <img src={subtract} alt="" />
                <p className="compass-text mb-0 text-center">
                  Run <br /> Thousands <br /> of Tasks
                </p>
              </div>
              <div className="test3">
                <img
                  style={{ position: "absolute", top: "-15px", left: "38%" }}
                  src={dollars}
                  alt=""
                />
                <img src={subtract} alt="" />
                <p className="compass-text mb-0 text-center">
                  Millions of <br /> dollars made <br /> between users
                </p>
              </div>
            </div>
          )}
          <div className="a-t-w-tweet">
            {isMobile ? (
              <img style={{ width: "100%" }} src={tweetmo} alt="tweet" />
            ) : (
              <img
      ...
      <section className="skip-to-front">
        <SkipToFrontCard
          h2={"Your ticket to the front of the line."}
          p={
            "Stellar is how you beat every other buyer to get the products you want. Sign up to get the fastest checkout on the market."
          }
        />
      </section>
          ...
          <Col>
            <CardGradient height={"28.8rem"} className="need-h-or-s-card2">
              <div className="need-h-or-s-div2">
                ...
                <div
                  style={{ width: "20rem" }}
                  className="d-flex justify-content-between align-items-center mx-auto mt-30px"
                >
                  <a
                    href="https://twitter.com/stellara_io"
                    target={"_blank"}
                    rel="noreferrer"
                  >
                  ...
                  <a
                    href="https://www.instagram.com/stellaraio_/?hl=enwitter.com/stellara_io"
                    target={"_blank"}
                    rel="noreferrer"
                  >
                  ...
                  <a
                    href="https://discord.gg/EWKv9vPVjM"
                    target={"_blank"}
                    rel="noreferrer"
                  >
