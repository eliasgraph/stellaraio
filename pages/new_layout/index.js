    ...
    <>
      <div className="new-layout">
        <div className="new-notification-topbar">
          <p className="mb-0 text-center">💫 Big news! We just launched Stellar 3.0! </p>
          <span><a href="">see what's new <img src={ArrowRight} alt="arrow-right"/></a></span>
        </div>
            ...
            <Navbar expand="md" className='new-navbar'>
              ...
              <Collapse isOpen={isOpen} navbar>
                <Nav className="me-auto text-right z-index-1" navbar>
                  <NavItem className={`text-right ${linkActive === 'home' ? 'new-page-navbar-active' : ''}`}
                  onClick={()=>{setLinkActive('home')}}
                  >
                    <NavLink href="/new_layout">Home</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink 
                    href={"#"} 
                    className={`${linkActive === 'features' ? 'new-page-navbar-active' : ''}`}
                    onClick={()=>{linkClicked('new-features')}}
                    >Features</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink 
                    href={"#"}
                    className={`${linkActive === 'sites' ? 'new-page-navbar-active' : ''}`}
                    onClick={()=>{linkClicked('new-sites')}}
                    >
                      Sites
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink 
                    href={"#"} 
                    className={`${linkActive === 'faq' ? 'new-page-navbar-active' : ''}`}
                    onClick={()=>{linkClicked('new-faq')}}
                    >FAQ</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink 
                    href="/blog" 
                    className={`${linkActive === 'blog' ? 'new-page-navbar-active' : ''}`}
                    onClick={()=>{setLinkActive('blog')}}
                    >Blog</NavLink>
                  </NavItem>
                </Nav>
                <a
                  ...
                  // target={"_blank"}
                >
                  <Button className="new-gradient-button new-nav-btn">Dashboard</Button>
                </a>
              </Collapse>
            </Navbar>
          </div>
        ...
        <div className='new-l'>
              ...
              <Row>
                <Col md={6}>
                  <div className="new-whats-new-shortcuts-left">
                    ...
                    <Button className='new-learn-more-btn'>Learn more <TailIconSvg/>
                    </Button>
                  </div>
                </Col>
                <Col md={6}>
                  <div className="new-whats-new-shortcuts-right">
                    <img src={Frame1} alt="" className="new-whats-new-frame-1"/>
                    <img src={Frame2} alt="" className="new-whats-new-frame-2"/>
                    <img src={WhatsNewTopRightGlow} alt="" className="whats-new-top-right-glow"/>
                  </div>
                </Col>
              </Row>
            </div>
              ...
              <Row>
                <Col md={5}>
                  <div className="new-whats-new-middle-left">
                    ...
                    <Button className='new-learn-more-btn'>Learn more <TailIconSvg/></Button>
                    <div className="new-whats-new-table-img">
                      <img src={WhatsNewTable} alt=""/>
                    </div>
                    <img src={WhatsNewMiddleLeftGlow} alt="" className="whats-new-middle-left-glow"/>
                  </div>
                </Col>
                <Col md={7}>
                <div className="new-whats-new-middle-right">
                <img src={NewImproved} alt="" className="new-command-icon"/>
                    <img src={Command2} alt="" className="new-command-icon-2"/>
                    ...
                    <img src={WhatsNewMiddleRightGlow} alt="" className="what-new-middle-right-glow"/>
                  </div>
                </Col>
              </Row>
            </div>
            <div className="new-whats-new-bottom">
              <Row>
                <Col md={4}>
                  ...
                  <img src={Accessibility} alt="" className="new-command-icon"/>
          ...
          <div className="new-streamline-top-icon">
            ...
            <img src={FeaturesBigblur} alt="" className="features-big-blur-glow"/>
          </div>
              ...
              <Row>
                <Col md={8}>
                  <div className="new-streamline-left">
                    ...
                    <p>With a user-friendly interface, you can set up your automation in just a few clicks. Just a simple, intuitive software that lets you automate your purchasing process and get the items you want.</p>
                    <img src={Strealine1} alt=""/>
                    <img src={FeaturesTopLeftGlow} alt="" className="features-top-left-glow"/>
                  </div>
                </Col>
                <Col md={4}>
                  <div className="new-streamline-right">
                    ...
                    <img src={FeaturesTopRightGlow} alt="" className="features-top-right-glow"/>
                  </div>
                </Col>
              </Row>
            </div>
              ...
              <Row>
                <Col md={4}>
                  <div className="new-streamline-bottom-left">
                    <h3>24/7 Support</h3>
                    <p>With our 24/7 support, you can rest easy knowing that help is always just a click <br/> or phone call away.</p>
                    <img src={Strealine3} alt=""/>
                    <img src={FeaturesBottomLeftGlow} alt="" className="features-bottom-left-glow"/>
                  </div>
                </Col>
                <Col md={8}>
                  <div className="new-streamline-bottom-right">
                    ...
                    <img src={FeaturesBottomRightGlow} alt="" className="features-bottom-right-glow"/>
                  </div>
                </Col>
              </Row>
            </div>
          ...
          <p className="new-top-of-line new-section-top-heading text-center">HOW DOES IT WORK?</p>
                ...
                <Col md={6} sm={12}>
                  <div className="new-cad-content-left">
                    <div className="new-cad-step-num">
                      <div onClick={()=>{setActiveCad(0)}} className={`new-step-1 ${activeCad === 0 ? 'new-step-active': ''}`}><span >1</span>Create</div>

                      <div className="new-step-line"> </div>

                      <div onClick={()=>{setActiveCad(1)}} className={`new-step-2 ${activeCad === 1 ? 'new-step-active': ''}`}><span>2</span>Automate</div>

                      <div className="new-step-line"> </div>

                      <div onClick={()=>{setActiveCad(2)}} className={`new-step-3 ${activeCad === 2 ? 'new-step-active': ''}`}><span>3</span>Dominate</div>
                    </div>
                    <div className="new-cad-step-item-1">
                      <h3>{cadContent[activeCad].h2}</h3>
                      <p>
                        {cadContent[activeCad].p1}
                      </p>
                      <p>
                        {cadContent[activeCad].p2}
                      </p>

                      <div className="new-cad-step-nav">
                        <TabNavLeft fill= {activeCad > 0 ? '#FFFFFF':"#D7DFEF"} onClick={onCadBack}/>
                        <TabNavRight fill={ activeCad < 2 ? '#FFFFFF':"#D7DFEF"} onClick={onCadNext}/>
                      </div>
                    </div>
                  </div>
                </Col>
              ...
              <Row>
                <Col md={8}>
                  <div onClick={()=>{pushToBlog("/amazon-buy-bot")}}  className="new-our-blog-bottom-left">
                    ...
                    <img src={Amazon} alt=""/>
                    <img src={BlogLeftGlow} alt="" className="our-blog-left-glow"/>
                  </div>
                </Col>
                <Col md={4}>
                  <div 
          ...
          <section className="new-testimonials">
            ...
            <p>An intuitive and efficient UI/UX that allows for streamlined task creation <br/> and faster checkouts.</p>
            <div className="new-testimonials-items">
              <div className="new-testimonial-item">
                ...
                I never thought I'd be able to get my hands on the latest drops, but with Stellar, I was finally able to snag them!
                </p>
                <div className="new-testimonial-bottom">
                  ...
                  <p className="new-testimonial-review-date mb-0">Reviewed 02/14</p>
                </div>
              </div>
              <div className="new-testimonial-item">
                <div className="new-testimonial-top">
                ...
                <p className="new-testimonial-details">
                As a collector, I'm always on the lookout for rare and coveted items. This software has been a game-changer for me - it's helped me secure some of the most sought-after collectibles and electronics out there. Highly recommend!
                </p>
                <div className="new-testimonial-bottom">
              ...
              <div className="new-testimonial-item">
                ...
                <p className="new-testimonial-details">
                I was skeptical about using automation software at first, but after giving it a try, I'm a believer. I've been able to consistently purchase limited-edition sneakers without the hassle of constantly refreshing websites. It's saved me so much time and frustration.
                </p>
                <div className="new-testimonial-bottom">
              ...
              <div className="new-testimonial-item new-translate-up-30px">
                ...
                <p className="new-testimonial-details">
                I've been using this software for a few months now and I've been able to purchase sneakers that I never would have been able to get otherwise. The software is reliable and easy to use, and the customer support team is always available to help with any questions.
                </p>
                <div className="new-testimonial-bottom">
            ...
            <Button className='new-testimonial-view-more-btn new-gradient-button'>View More</Button>
          </section>
            ...
            <Row>
              <Col md={5}>
                <div className="faq-left">
                  ...
                  <h2>FAQs</h2>
                    <p>
                      An intuitive and efficient UI/UX that allows for streamlined task creation and faster <br/> checkouts.
                    </p>
       ...
       faq ? (
          ...
          <div className="faq__faqs">
            ...
            {faq.faq_question_1 ? <div className={`new-faq__faqs--item ${isOpenFaq1 ?'new-faq-active':'' }`}>
              <h6
            ...
            {faq.faq_question_2 ? <div className={`new-faq__faqs--item ${isOpenFaq2 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
            ...
            {faq.faq_question_3 ? <div className={`new-faq__faqs--item ${isOpenFaq3 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
            ...
            {faq.faq_question_4 ? <div className={`new-faq__faqs--item ${isOpenFaq4 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
            ...
            {faq.faq_question_5 ? <div className={`new-faq__faqs--item ${isOpenFaq5 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
          ...
          <div className="new-faq__faqs">
            ...
            <div className={`new-faq__faqs--item ${isOpenFaq1 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
                onClick={()=>{setIsOpenFaq1(!isOpenFaq1)}}
              >
            ...
            <div className={`new-faq__faqs--item ${isOpenFaq2 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
                onClick={()=>{setIsOpenFaq2(!isOpenFaq2)}}
              >
            ...
            <div className={`new-faq__faqs--item ${isOpenFaq3 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
                onClick={()=>{setIsOpenFaq3(!isOpenFaq3)}}
              >
            ...
            <div className={`new-faq__faqs--item ${isOpenFaq4 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
                onClick={()=>{setIsOpenFaq4(!isOpenFaq4)}}
              >
            ...
            <div className={`new-faq__faqs--item ${isOpenFaq5 ?'new-faq-active':'' }`}>
              <h6
                className='d-flex align-items-center justify-content-between'
                onClick={()=>{setIsOpenFaq5(!isOpenFaq5)}}
              >
          ...
          <section className="new-by-numbers">
            <p className='new-top-of-line new-section-top-heading text-center my-0'>by the numbers</p>
